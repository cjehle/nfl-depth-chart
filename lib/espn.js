...
async function buildLineup(cfg, team, unit, season) {
  ...
  // Current video-game ratings apply to the CURRENT roster only — don't stamp them
  // onto a past-season lineup (a 2022 XI with 2026 ratings would be wrong).
  const ratingLabel = hist ? null : ratings.publisher(cfg.key);
  if (ratingLabel) {
