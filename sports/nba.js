...
module.exports = {
  ...
  layout: [
    { key: "C", label: "Center", posKey: "c", group: "Center", x: 50, y: 14 },
    { key: "PF", label: "Power Forward", posKey: "pf", group: "Forwards", x: 27, y: 22 },
    { key: "SF", label: "Small Forward", posKey: "sf", group: "Forwards", x: 76, y: 28 },
    { key: "SG", label: "Shooting Guard", posKey: "sg", group: "Guards", x: 20, y: 42 },
    { key: "PG", label: "Point Guard", posKey: "pg", group: "Guards", x: 56, y: 47 },
  ],
};
